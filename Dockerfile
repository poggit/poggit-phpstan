...
RUN wget -qO /usr/bin/phpstan https://github.com/phpstan/phpstan/releases/download/1.2.0/phpstan.phar
...
ENTRYPOINT ["timeout", "600", "php", "-dphar.readonly=0", "/usr/bin/entry"]
CMD []
